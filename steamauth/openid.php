 ...
 * @link        //code.google.com/p/lightopenid/          Project URL
 * @link        //github.com/iignatov/LightOpenID         GitHub Repo
...
class LightOpenID
{
    ...
    protected function get_realm_protocol()
    {
        ...
        return $use_secure_protocol ? '//' : 'http://';
    }
    ...
    protected function authUrl_v2($immediate)
    {
        ...
        if (!empty($this->oauth) && is_array($this->oauth)) {
            ...
            $params['openid.oauth.consumer'] = str_replace(array('http://', '//'), '', $this->trustRoot);
     ...
     * $openid->oauth[] = '//www.googleapis.com/auth/plus.me';
     * 
     * Furthermore the registered consumer name must fit the OpenID realm. 
     * To register an OpenID consumer at Google use: //www.google.com/accounts/ManageDomains
     * 
